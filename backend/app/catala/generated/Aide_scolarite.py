...
loc = (Array([SourcePosition(filename="src/aide_scolarite/aide_scolarite.catala_fr", start_line=61, start_column=12, end_line=61, end_column=26, law_headings=["Objet :", "AIDE À LA SCOLARITÉ"]),
              ...
              SourcePosition(filename="src/aide_scolarite/aide_scolarite.catala_fr", start_line=173, start_column=11, end_line=173, end_column=17, law_headings=["I – Détermination du Quotient Familial (QF)", "Mode de calcul du montant de la prestations (Cf. Annexes F16a et F16b à remplir et à joindre au dossier) :", "AIDE À LA SCOLARITÉ"]),
              SourcePosition(filename="src/aide_scolarite/aide_scolarite.catala_fr", start_line=185, start_column=14, end_line=185, end_column=45, law_headings=["I – Détermination du Quotient Familial (QF)", "Mode de calcul du montant de la prestations (Cf. Annexes F16a et F16b à remplir et à joindre au dossier) :", "AIDE À LA SCOLARITÉ"]),
              SourcePosition(filename="src/aide_scolarite/aide_scolarite.catala_fr", start_line=209, start_column=22, end_line=210, end_column=114, law_headings=["I – Détermination du Quotient Familial (QF)", "Mode de calcul du montant de la prestations (Cf. Annexes F16a et F16b à remplir et à joindre au dossier) :", "AIDE À LA SCOLARITÉ"]),
              SourcePosition(filename="src/aide_scolarite/aide_scolarite.catala_fr", start_line=235, start_column=22, end_line=235, end_column=25, law_headings=["I – Détermination du Quotient Familial (QF)", "Mode de calcul du montant de la prestations (Cf. Annexes F16a et F16b à remplir et à joindre au dossier) :", "AIDE À LA SCOLARITÉ"]),
              SourcePosition(filename="src/aide_scolarite/aide_scolarite.catala_fr", start_line=259, start_column=11, end_line=259, end_column=39, law_headings=["II - Mode de calcul des points (des justificatifs sont requis pour valider chaque point obtenu dans chaque critère)", "Mode de calcul du montant de la prestations (Cf. Annexes F16a et F16b à remplir et à joindre au dossier) :", "AIDE À LA SCOLARITÉ"]),
